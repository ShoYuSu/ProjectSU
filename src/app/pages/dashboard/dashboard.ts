import { Component, signal, OnInit, inject } from '@angular/core'; // 1. เติม OnInit และ inject
import { CommonModule } from '@angular/common';
import { ActivatedRoute } from '@angular/router'; // 2. เติม ActivatedRoute
    ...
    <div class="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 flex flex-col justify-between">
          ...
          <div>
            <p class="text-[11px] font-bold text-gray-400 mb-1">บุคลากรรวมทั้งหมด</p>
            <h3 class="text-5xl font-black text-[#2A1D1A]">120</h3>
            <div class="flex gap-8 mt-6">
              <div><span class="text-[10px] text-gray-400">อาจารย์</span><p class="text-sm font-black text-[#2A1D1A]">92</p></div>
              <div><span class="text-[10px] text-gray-400">เจ้าหน้าที่</span><p class="text-sm font-black text-[#2A1D1A]">28</p></div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 flex flex-col justify-between">
          ...
          <div>
            <p class="text-[11px] font-bold text-gray-400 mb-1">บทความวิจัยทั้งหมด</p>
            <h3 class="text-5xl font-black text-[#2A1D1A]">3,482</h3>
            <div class="flex gap-8 mt-6">
              <div><span class="text-[10px] text-gray-400">ประชุมวิชาการ</span><p class="text-sm font-black text-[#2A1D1A]">1,672</p></div>
              <div><span class="text-[10px] text-gray-400">วารสาร</span><p class="text-sm font-black text-[#2A1D1A]">1,810</p></div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 flex flex-col justify-between">
          ...
          <div>
            <p class="text-[11px] font-bold text-gray-400 mb-1">โครงการวิจัยทั้งหมด</p>
            <h3 class="text-5xl font-black text-[#2A1D1A]">528</h3>
            <div class="flex gap-8 mt-6">
              <div><span class="text-[10px] text-gray-400">ทุน (บาท)</span><p class="text-sm font-black text-[#2A1D1A]">1,265,050</p></div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white rounded-3xl p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
        ...
        <div class="h-64 flex items-end justify-around relative px-10 pb-6 mt-4">
          <div class="absolute left-0 top-0 bottom-6 flex flex-col justify-between text-[10px] text-gray-400 font-medium"><span>100</span><span>75</span><span>50</span><span>25</span><span>0</span></div>
          <div class="absolute left-8 right-8 top-0 h-px bg-gray-100"></div>
          <div class="absolute left-8 right-8 top-1/4 h-px bg-gray-100"></div>
          <div class="absolute left-8 right-8 top-2/4 h-px bg-gray-100"></div>
          <div class="absolute left-8 right-8 top-3/4 h-px bg-gray-100"></div>
      ...
      <div class="bg-white rounded-3xl p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 mb-10">
        <div class="mb-8">
          <h3 class="font-bold text-[#2A1D1A] text-base flex items-center gap-2 mb-1">
            <div class="w-3 h-3 rounded-full bg-[#F9BD15]"></div>
            สถานะโครงการ
          </h3>
          <p class="text-xs text-gray-400 ml-5">สัดส่วนโครงการแยกตามสถานะปัจจุบัน</p>
        </div>

        <div class="flex flex-col md:flex-row items-center justify-center gap-16 py-4">

          <div class="relative w-48 h-48 rounded-full flex items-center justify-center"
               style="background: conic-gradient(#FDE68A 0% 30%, #FBBF24 30% 82%, #D97706 82% 100%);">
            <div class="w-32 h-32 bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
              <h3 class="text-3xl font-black text-[#2A1D1A]">528</h3>
              <p class="text-[10px] text-gray-400 font-bold">โครงการ</p>
            </div>
          </div>

          <div class="space-y-6">
            <div class="flex items-start gap-3">
              <div class="w-3 h-3 rounded-full bg-[#FDE68A] mt-1"></div>
              <div>
                <p class="text-sm font-bold text-[#2A1D1A]">ยังไม่ได้ดำเนินการ</p>
                <p class="text-xs text-gray-400">156 โครงการ (30%)</p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              <div class="w-3 h-3 rounded-full bg-[#FBBF24] mt-1"></div>
              <div>
                <p class="text-sm font-bold text-[#2A1D1A]">อยู่ระหว่างดำเนินการ</p>
                <p class="text-xs text-gray-400">275 โครงการ (52%)</p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              <div class="w-3 h-3 rounded-full bg-[#D97706] mt-1"></div>
              <div>
                <p class="text-sm font-bold text-[#2A1D1A]">ดำเนินการเสร็จสิ้น</p>
                <p class="text-xs text-gray-400">97 โครงการ (18%)</p>
              </div>
            </div>
          </div>
...
export class DashboardComponent implements OnInit { // 3. เพิ่ม implements OnInit

  // 4. ====== เพิ่มส่วนนี้เพื่อดึงค่าจาก URL มาลง localStorage ======
