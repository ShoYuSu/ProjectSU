  ...
  template: `
    <div class="max-w-[1200px] mx-auto animate-in fade-in duration-500 pb-10 space-y-6">
      ...
      <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden relative">
         ...
         <div class="overflow-x-auto min-h-[300px] custom-scrollbar pb-4"> <table class="w-full text-left min-w-[1800px]">
               ...
               <tbody class="divide-y divide-gray-50">
                  @if (paginatedTrainings().length > 0) {
      ...
      </div> <div class="flex justify-center items-center py-4">
